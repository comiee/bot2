...
class BaikeTestCase(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_baike(self):
        ...
        self.assertEqual(
            ...
            '机器人具有感知、决策、执行等基本特征，可以辅助甚至替代人类完成危险、繁重、复杂的工作，'
            '提高工作效率与质量，服务人类生活，扩大或延伸人的活动及能力范围。 2021年，美国1/3的手术是使用机器人系统进行的。'
            ' 2023年，美国亚利桑那州立大学（ASU）科学家研制出了世界上第一个能像人类一样出汗、颤抖和呼吸的户外行走机器人模型。\n'
            '————来自百度百科',
            text)
