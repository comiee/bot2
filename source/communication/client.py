...
class Client:
    ...
    def register(self, client_type):
        ...
        send_msg(sock, register_msg.build(name=self.name, client_type=client_type))
    ...
    def send(self, msg: str):
        try:
            ...
            ret = result_msg.parse(recv_msg(self.sender))
    ...
    def listen_server(self):
        ...
        while True:
            try:
                ...
                send_msg(self.receiver, result_msg.build(ret))
